...
-- Make sent_at NOT NULL after setting values
ALTER TABLE messages 
ALTER COLUMN sent_at SET NOT NULL;

-- Add constraint to prevent users from messaging themselves (with proper syntax)
DO $$ 
BEGIN
    ALTER TABLE messages ADD CONSTRAINT check_different_users CHECK (sender_id != receiver_id);
EXCEPTION
